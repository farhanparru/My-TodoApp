          ...
          <form className="max-w-lg w-full mx-auto" >
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input name="username" type="text" required  value={formData.username} onChange={handleChange} className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none"  placeholder="Enter name" />
            ...
            <div className="mt-8">
              ...
              <div className="relative flex items-center">
                ...
                <input name="email" type="text" required value={formData.email} onChange={handleChange} className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter email" />
            ...
            <div className="mt-8">
              ...
              <div className="relative flex items-center">
                ...
                <input name="password"  type={viewPassword ? "text" : "password"}  required value={formData.password} onChange={handleChange} className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter password" />

                
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2 cursor-pointer" viewBox="0 0 128 128"  onClick={()=> setViewPassword(!viewPassword)}>
                <path
        d={
          viewPassword
            ...
            : "M64 104C22.127 104 1.367 67.496.504 65.943a4 4 0 0 1 0-3.887C1.367 60.504 22.127 24 64 24s62.633 36.504 63.496 38.057a4 4 0 0 1 0 3.887C126.633 67.496 105.873 104 64 104z"
        }
      />
                </svg>
              </div>
            ...
            <div className="mt-8">
              ...
              <select
                ...
                className="w-full bg-transparent text-sm text-white border-b border-gray-500 focus:border-yellow-400 px-2 py-3 outline-none"
              >
            ...
            <div className="mt-12">
              <button type="button" className="w-max shadow-xl py-3 px-6 text-sm text-gray-800 font-semibold rounded-md bg-transparent bg-yellow-400 hover:bg-yellow-500 focus:outline-none" onClick={handlesubmit}>
                Register
              </button>
